...
namespace ASP_GCH1107_NguyenVanTruong.Controllers
{
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TotalPrice,ProductId,Submitted")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TotalPrice,ProductId,Submitted")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
